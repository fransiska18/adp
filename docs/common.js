...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getJson = function (file_json) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('file_json', file_json);
        return this.http.get(this.apiUrl + "/get-json", { params: params });
    };
    // Method to update the JSON file on the backend
    DataService.prototype.updateJson = function (file_json, data, item_id, satus_tasklist) {
        return this.http.post(this.apiUrl + "/update-json", { file_json: file_json, data: data, item_id: item_id, satus_tasklist: satus_tasklist });
    };

...
var map = {
	...
	"./call-barchart/call-barchart.module": [
		"./src/app/call-barchart/call-barchart.module.ts",
		"default~call-barchart-call-barchart-module~cards-cards-module~charts-charts-module",
		"default~call-barchart-call-barchart-module~charts-charts-module",
		"common"
	],
	"./call-gaugechart/call-gaugechart.module": [
		"./src/app/call-gaugechart/call-gaugechart.module.ts",
		"default~call-gaugechart-call-gaugechart-module~charts-charts-module~dashboard-dashboard-module~pages~4187b17a",
		"default~call-gaugechart-call-gaugechart-module~charts-charts-module",
		"common"
	],
	"./cards/cards.module": [
	...
	"./chat-ngrx/chat-ngrx.module": [
		...
		"default~chat-chat-module~chat-ngrx-chat-ngrx-module~player-player-module",
		"common",
		"chat-ngrx-chat-ngrx-module"
	],
	"./chat/chat.module": [
	...
	"./components/ui-components.module": [
		...
		"default~components-ui-components-module~office-office-module~pdf-view-detail-pdf-view-detail-module",
		"default~components-ui-components-module~inbox-inbox-module",
		"common",
		"components-ui-components-module"
	],
	...
	"./forms/forms.module": [
		...
		"default~forms-forms-module~ngx-wizard-ngx-wizard-module",
		"common",
		"forms-forms-module"
	],
	"./inbox/inbox.module": [
	...
	"./office/office.module": [
		...
		"default~components-ui-components-module~office-office-module~pdf-view-detail-pdf-view-detail-module",
		"default~office-office-module~pdf-view-detail-pdf-view-detail-module",
		"common",
		"office-office-module"
	],
	...
	"./pdf-view-detail/pdf-view-detail.module": [
		"./src/app/pdf-view-detail/pdf-view-detail.module.ts",
		"default~components-ui-components-module~office-office-module~pdf-view-detail-pdf-view-detail-module",
		"default~office-office-module~pdf-view-detail-pdf-view-detail-module",
		"default~pdf-view-detail-pdf-view-detail-module~tables-tables-module",
		"common",
		"pdf-view-detail-pdf-view-detail-module"
	],
...
/* harmony import */ var app_interceptor_httpconfig_interceptor__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! app/interceptor/httpconfig.interceptor */ "./src/app/interceptor/httpconfig.interceptor.ts");
...
/* harmony import */ var _error_dialog_error_dialog_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./error-dialog/error-dialog.service */ "./src/app/error-dialog/error-dialog.service.ts");
...
/* harmony import */ var _callAPI_api_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./callAPI/api.service */ "./src/app/callAPI/api.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                ...
                _layouts_full_full_layout_component__WEBPACK_IMPORTED_MODULE_15__["FullLayoutComponent"],
                _layouts_content_content_layout_component__WEBPACK_IMPORTED_MODULE_14__["ContentLayoutComponent"],
            ],
            imports: [
            ...
            providers: [
                _callAPI_api_service__WEBPACK_IMPORTED_MODULE_21__["apiservice"],
                ...
                _error_dialog_error_dialog_service__WEBPACK_IMPORTED_MODULE_18__["ErrorDialogService"],
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HTTP_INTERCEPTORS"], useClass: app_interceptor_httpconfig_interceptor__WEBPACK_IMPORTED_MODULE_12__["HttpConfigInterceptor"], multi: true }
            ],
...
/***/ "./src/app/callAPI/api.service.ts":
/*!****************************************!*\
  !*** ./src/app/callAPI/api.service.ts ***!
  \****************************************/
...
var apiservice = /** @class */ (function () {
    ...
    function apiservice(http) {
        this.http = http;
        this.jsonUrl = ('assets/tasklist.json');
    }
    ;
...
var NGXToastrService = /** @class */ (function () {
    ...
    NGXToastrService.prototype.errorMessage = function (msg) {
        this.toastr.info(msg);
    };
    NGXToastrService.prototype.typeSave = function (msg) {
        this.toastr.success(msg);
    };
    NGXToastrService.prototype.typeErrorCustom = function (msg) {
        this.toastr.error(msg);
    };
    NGXToastrService.prototype.successMessage = function (msg) {
        this.toastr.success(msg, 'Success!');
    };
    NGXToastrService.prototype.errorAPI = function (status, reason) {
...
/* harmony import */ var app_components_extra_toastr_toastr_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/components/extra/toastr/toastr.service */ "./src/app/components/extra/toastr/toastr.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ErrorDialogComponent = /** @class */ (function () {
    function ErrorDialogComponent(data, toastr) {
        this.data = data;
        this.toastr = toastr;
    ...
    ErrorDialogComponent.prototype.ngAfterViewInit = function () {
    ...
    ErrorDialogComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./error-dialog.component.scss */ "./src/app/error-dialog/error-dialog.component.scss")],
            providers: [app_components_extra_toastr_toastr_service__WEBPACK_IMPORTED_MODULE_2__["NGXToastrService"]]
        }),
        __param(0, Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Inject"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MAT_DIALOG_DATA"])),
        __metadata("design:paramtypes", [String, app_components_extra_toastr_toastr_service__WEBPACK_IMPORTED_MODULE_2__["NGXToastrService"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm5/material.es5.js");
/* harmony import */ var app_error_dialog_error_dialog_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! app/error-dialog/error-dialog.component */ "./src/app/error-dialog/error-dialog.component.ts");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var app_shared_AdInstConstant__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/shared/AdInstConstant */ "./src/app/shared/AdInstConstant.ts");
...
var ErrorDialogService = /** @class */ (function () {
    function ErrorDialogService(dialog, http) {
        this.dialog = dialog;
        this.http = http;
    }
    ErrorDialogService.prototype.openDialog = function (data) {
        ...
        if (data.status == "001" && localStorage.getItem("Username") != undefined) {
            var url = environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].foundationUrl + app_shared_AdInstConstant__WEBPACK_IMPORTED_MODULE_4__["AdInsConstant"].Logout;
            this.http.post(url, "");
        }
        var dialogRef = this.dialog.open(app_error_dialog_error_dialog_component__WEBPACK_IMPORTED_MODULE_2__["ErrorDialogComponent"], {
            width: '300px',
            position: {
                top: '12px',
                right: '12px'
...
/* harmony import */ var app_shared_model_HttpRequestObj_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/shared/model/HttpRequestObj.model */ "./src/app/shared/model/HttpRequestObj.model.ts");
/* harmony import */ var ngx_spinner__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-spinner */ "./node_modules/ngx-spinner/fesm5/ngx-spinner.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var app_shared_AdInsHelper__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! app/shared/AdInsHelper */ "./src/app/shared/AdInsHelper.ts");
/* harmony import */ var app_error_dialog_error_dialog_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/error-dialog/error-dialog.service */ "./src/app/error-dialog/error-dialog.service.ts");
...
var HttpConfigInterceptor = /** @class */ (function () {
    function HttpConfigInterceptor(errorDialogService, spinner, router) {
    ...
    HttpConfigInterceptor.prototype.intercept = function (request, next) {
        ...
        this.count++;
        var httpRequest = new app_shared_model_HttpRequestObj_model__WEBPACK_IMPORTED_MODULE_4__["HttpRequestObj"]();
        ...
        var myObj;
        var today = new Date();
        var businessDt = Object(_angular_common__WEBPACK_IMPORTED_MODULE_6__["formatDate"])(today, 'yyyy-MM-dd', 'en-US');
        var checkSession = app_shared_AdInsHelper__WEBPACK_IMPORTED_MODULE_7__["AdInsHelper"].CheckSessionTimeout();
        if (checkSession == "1") {
        ...
        app_shared_AdInsHelper__WEBPACK_IMPORTED_MODULE_7__["AdInsHelper"].InsertLog(request.url, "API", request.body);
        ...
        return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (event) {
            ...
            if (_this.count == 0) {
                if (request.method == "POST") {
                    app_shared_AdInsHelper__WEBPACK_IMPORTED_MODULE_7__["AdInsHelper"].ClearPageAccessLog();
                    _this.spinner.hide();
                }
            }
        }));
    ...
    HttpConfigInterceptor = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [app_error_dialog_error_dialog_service__WEBPACK_IMPORTED_MODULE_8__["ErrorDialogService"], ngx_spinner__WEBPACK_IMPORTED_MODULE_5__["NgxSpinnerService"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"]])
...
/***/ "./src/app/shared/AdInsHelper.ts":
/*!***************************************!*\
  !*** ./src/app/shared/AdInsHelper.ts ***!
  \***************************************/
/*! exports provided: AdInsHelper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdInsHelper", function() { return AdInsHelper; });
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var app_shared_AdInstConstant__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! app/shared/AdInstConstant */ "./src/app/shared/AdInstConstant.ts");


var AdInsHelper = /** @class */ (function () {
    function AdInsHelper() {
    }
    //Function
    AdInsHelper.InsertLog = function (url, type, param) {
        if (param === void 0) { param = ""; }
        var today = new Date();
        var dateNow = Object(_angular_common__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(today, 'yyyy-MM-dd hh:mm:ss', 'en-US');
        var listPageAccess = [];
    ...
    AdInsHelper.ClearAllLog = function () {
    ...
    AdInsHelper.ClearPageAccessLog = function () {
        localStorage.removeItem("PageAccess");
    };
    AdInsHelper.CheckSessionTimeout = function () {
        var today = new Date();
        var businessDtBefore = localStorage.getItem("LastAccessTime");
        var businessDtNow = Object(_angular_common__WEBPACK_IMPORTED_MODULE_0__["formatDate"])(today, 'yyyy-MM-dd HH:mm:ss', 'en-US');
        if (businessDtBefore == undefined || businessDtBefore == null) {
            ...
            if (tempDate > app_shared_AdInstConstant__WEBPACK_IMPORTED_MODULE_1__["AdInsConstant"].TimeoutSession) {
    ...
    AdInsHelper.IsGrantAccess = function (formPath) {
        var temp = localStorage.getItem("Menu");
        var objectMenu = [];
        objectMenu = JSON.parse(temp);
        if (objectMenu != null) {
            var exsisting = objectMenu['find'](function (x) { return x.path === formPath; });
...
/***/ "./src/app/shared/AdInstConstant.ts":
/*!******************************************!*\
  !*** ./src/app/shared/AdInstConstant.ts ***!
  \******************************************/
/*! exports provided: AdInsConstant */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AdInsConstant", function() { return AdInsConstant; });
var AdInsConstant = /** @class */ (function () {
    ...
    AdInsConstant.GetAllActiveRefFormAndPathExist = "/MenuManagement/GetAllActiveRefFormAndPathExist";
    AdInsConstant.GetAllActiveRefForm = "/MenuManagement/GetAllActiveRefForm";
    //FORM FEATURE
    ...
    //GENERIC
    AdInsConstant.GetObjectBySQL = "/Generic/GetObjectBySQL";
    AdInsConstant.AddObjectBySQL = "/Generic/AddObjectBySQL";
    AdInsConstant.UpdateObjectBySQL = "/Generic/UpdateObjectBySQL";
    AdInsConstant.DeleteObjectBySQL = "/Generic/DeleteObjectBySQL";
    //WORKHOUR
    ...
    //QUEUE
    AdInsConstant.AddQueue = "http://R3App-Server/FOUNDATION/RabbitMq/AddQueue";
    //REF MODULE
    AdInsConstant.GetListRefModuleKeyValue = "/RefModule/GetListRefModuleKeyValue";
...
module.exports = ".customizer {\n  width: 400px;\n  right: -400px;\n  padding: 0;\n  background-color: #FFF;\n  z-index: 1051;\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  height: 100vh;\n  transition: right 0.4s cubic-bezier(0.05, 0.74, 0.2, 0.99);\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n  box-shadow: 0 0 8px rgba(0, 0, 0, 0.1); }\n  .customizer.open {\n    right: 0; }\n  .customizer .customizer-content {\n    position: relative;\n    height: 100%; }\n  .customizer a.customizer-toggle {\n    background: #FFF;\n    color: theme-color(\"primary\");\n    display: block;\n    box-shadow: -3px 0px 8px rgba(0, 0, 0, 0.1); }\n  .customizer a.customizer-close {\n    color: #000; }\n  .customizer .customizer-close {\n    position: absolute;\n    right: 10px;\n    top: 10px;\n    padding: 7px;\n    width: auto;\n    z-index: 10; }\n  .customizer .customizer-toggle {\n    position: absolute;\n    top: 35%;\n    width: 54px;\n    height: 50px;\n    left: -54px;\n    text-align: center;\n    line-height: 50px;\n    cursor: pointer; }\n  .customizer .color-options a {\n    white-space: pre; }\n  .customizer .cz-bg-color {\n    margin: 0 auto; }\n  .customizer .cz-bg-color span:hover {\n      cursor: pointer; }\n  .customizer .cz-bg-color span.white {\n      color: #ddd !important; }\n  .customizer .cz-bg-color .selected {\n      border: 3px solid #314fe5; }\n  .customizer .cz-bg-image:hover {\n    cursor: pointer; }\n  .customizer .cz-bg-image img.rounded {\n    border-radius: 1rem !important;\n    border: 2px solid #e6e6e6; }\n  .customizer .cz-bg-image img.rounded.selected {\n      border: 2px solid #FF586B; }\n  [dir=rtl] :host ::ng-deep .customizer {\n  left: -400px;\n  right: auto;\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n  border-left: 0px; }\n  [dir=rtl] :host ::ng-deep .customizer.open {\n    left: 0;\n    right: auto; }\n  [dir=rtl] :host ::ng-deep .customizer .customizer-close {\n    left: 10px;\n    right: auto; }\n  [dir=rtl] :host ::ng-deep .customizer .customizer-toggle {\n    right: -54px;\n    left: auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
module.exports = "<!--Footer Starts-->\r\n<footer>\r\n    <div class=\"container-fluid\">\r\n        <p class=\"copyright text-center\">\r\n                Copyright  &copy;  {{currentDate | date: 'yyyy'}} <a id=\"pixinventLink\" href=\"https://www.ad-ins.com/id/\">AdIns, Data Analytics Team</a>, All rights reserved.          \r\n        </p>\r\n        \r\n    </div>\r\n</footer>\r\n<!--Footer Ends-->"
...
/***/ "./src/app/shared/model/HttpRequestObj.model.ts":
/*!******************************************************!*\
  !*** ./src/app/shared/model/HttpRequestObj.model.ts ***!
  \******************************************************/
/*! exports provided: HttpRequestObj */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HttpRequestObj", function() { return HttpRequestObj; });
var HttpRequestObj = /** @class */ (function () {
...
module.exports = "#notification-sidebar {\n  width: 400px;\n  right: -400px;\n  padding: 0;\n  background-color: #FFF;\n  z-index: 1051;\n  position: fixed;\n  top: 0;\n  bottom: 0;\n  height: 100vh;\n  transition: right 0.4s cubic-bezier(0.05, 0.74, 0.2, 0.99);\n  -webkit-backface-visibility: hidden;\n          backface-visibility: hidden;\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n  box-shadow: 0 0 8px rgba(0, 0, 0, 0.1); }\n  #notification-sidebar.open {\n    right: 0; }\n  #notification-sidebar .notification-sidebar-content {\n    position: relative;\n    height: 100%;\n    padding: 10px; }\n  #notification-sidebar .notification-sidebar-content #timeline.timeline-left .timeline-item:before {\n      border: none; }\n  #notification-sidebar .notification-sidebar-content #timeline.timeline-left .timeline-item:after {\n      border: none; }\n  #notification-sidebar a.notification-sidebar-toggle {\n    background: #FFF;\n    color: theme-color(\"primary\");\n    display: block;\n    box-shadow: -3px 0px 8px rgba(0, 0, 0, 0.1); }\n  #notification-sidebar a.notification-sidebar-close {\n    color: #000; }\n  #notification-sidebar .notification-sidebar-close {\n    position: absolute;\n    right: 10px;\n    top: 10px;\n    padding: 7px;\n    width: auto;\n    z-index: 10; }\n  #notification-sidebar .notification-sidebar-toggle {\n    position: absolute;\n    top: 35%;\n    width: 54px;\n    height: 50px;\n    left: -54px;\n    text-align: center;\n    line-height: 50px;\n    cursor: pointer; }\n  [dir=\"rtl\"] :host ::ng-deep #notification-sidebar {\n  left: -400px;\n  right: auto; }\n  [dir=\"rtl\"] :host ::ng-deep #notification-sidebar.open {\n    left: 0;\n    right: auto; }\n  [dir=\"rtl\"] :host ::ng-deep #notification-sidebar .notification-sidebar-close {\n    left: 10px;\n    right: auto; }\n  [dir=\"rtl\"] :host ::ng-deep #notification-sidebar .notification-sidebar-toggle {\n    right: -54px;\n    left: auto; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var Full_ROUTES = [
    ...
    {
        path: 'CallGaugecharts',
        loadChildren: './call-gaugechart/call-gaugechart.module#CallGaugechartModule'
    },
    {
        path: 'forms',
...
var ROUTES = [
    ...
    //         { path: '/office', title: 'Office', icon: '', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    //     ]
    // },
    { path: '/tasklist', title: 'Task List', icon: 'ft-file-text', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
    { path: '/testing', title: 'Users & Permissions', icon: 'ft-user', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: [] },
];
...
module.exports = __webpack_require__(/*! D:\BSA+ HITL\BSA github\adp\src\main.ts */"./src/main.ts");
